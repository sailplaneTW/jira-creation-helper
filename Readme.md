Jira is a great tool to manage issues, but there are many fields should be filled when creating issue. Write a greasemonkey/tampermonkey script to fill several fields automatically.
